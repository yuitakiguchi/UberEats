                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @unless (Auth::guard('shop')->check())
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('shop.login') }}">{{ __('ログイン') }}</a>
                            </li>
                            @if (Route::has('shop.register'))
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('shop.register') }}">{{ __('新規登録') }}</a>
                                </li>
                            @endif
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    <a class="dropdown-item" href="{{ route('shops.edit', Auth::user()->id )}}" >
                                        {{ __('ユーザー') }}
                                    </a>
